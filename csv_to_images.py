...
parser.add_argument('-f', '--file', required=True, help="/home/furkanbilen/FaceEmotion_ID-master/fer2013")
parser.add_argument('-o', '--output', required=True, help="/home/furkanbilen/FaceEmotion_ID-master")
